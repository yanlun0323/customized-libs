...
import com.customized.libs.shardingsphere.entity.common.CommonErrCode;
import com.customized.libs.shardingsphere.entity.common.CommonException;
...
public class ExceptionHandleController extends BaseController {
    ...
    private static Logger log = LoggerFactory.getLogger(ExceptionHandleController.class);
    ...
    public ResponseEntity<CommResp> sentinelBlockHandler(BlockException e) {
        ...
        log.warn("Blocked by Sentinel: {}", rule.toString());
    ...
    @ExceptionHandler(value = {RuntimeException.class, Exception.class, Throwable.class, FlowException.class})
    @ResponseBody
