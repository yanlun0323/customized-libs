...
public class MyDynamicProxyV4 {
    ...
    public static void main(String[] args) {
        ...
        proxyService = (HelloService) new LogInterceptor().plugin(proxyService);
        proxyService = (HelloService) new Log2Interceptor().plugin(proxyService);
