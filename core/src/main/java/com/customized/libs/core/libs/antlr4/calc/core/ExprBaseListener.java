...
public class ExprBaseListener implements ExprListener {
     ...
     */
    @Override
    public void enterMul_Div_Mod(ExprParser.Mul_Div_ModContext ctx) {
    }
     ...
     */
    @Override
    public void enterNegativeNumber(ExprParser.NegativeNumberContext ctx) {
    }
     ...
     */
    @Override
    public void enterAdd_Sub(ExprParser.Add_SubContext ctx) {
    }
     ...
     */
    @Override
    public void enterPow(ExprParser.PowContext ctx) {
    }
     ...
     */
    @Override
    public void enterParentheses(ExprParser.ParenthesesContext ctx) {
    }
