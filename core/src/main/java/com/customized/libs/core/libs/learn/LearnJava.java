package com.customized.libs.core.libs.learn;
/**
 * default package
 */
...
public class LearnJava {
    ...
    static ProcessResult runJava13Program(String code) throws IOException, InterruptedException {
        ...
        return getProcessResult(pb.start());
    }
    ...
    static String readAsString(InputStream input, Charset charset) throws IOException {
        ...
        return output.toString(charset.toString());
    }
