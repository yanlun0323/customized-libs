 ...
 * @date 2022/3/7 11:30
 */
@Service("GobrsCService")
@Slf4j
public class GobrsCService implements AsyncTask<Map<String, String>, Void> {
    ...
    public Void task(Map<String, String> params, GobrsAsyncSupport support) {
        ...
        params.put("C", "GobrsCService");
        log.info("Gobrs C Service Execute! ==> {}", params);
        return null;
    }
