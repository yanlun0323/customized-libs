 ...
 * @date 2022/3/7 11:30
 */
@Service("GobrsBService")
@Slf4j
public class GobrsBService implements AsyncTask<Map<String, String>, Void> {
    ...
    public Void task(Map<String, String> params, GobrsAsyncSupport support) {
        ...
        params.put("B", "GobrsBService");
        log.info("Gobrs B Service Execute! ==> {}", params);
        return null;
    }
